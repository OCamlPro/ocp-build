...
let get_config cmd =
   match get_stdout_lines [ cmd ] [ "-config" ] with
   | `EXN e -> raise e
   | `OUTPUT (_,c) ->
...
let check_is_compiler prefix_sep ocamlc_prefixes args ocamlc =
  match get_stdout_lines [ ocamlc ] args with
  | `EXN e ->
...
let ocamllex_cmd = BuildValue.new_strings_option "ocamllex" [ "ocamllex.opt" ]
let ocamlyacc_cmd = BuildValue.new_strings_option "ocamlyacc" [ "ocamlyacc" ]
let ocamlmklib_cmd = BuildValue.new_strings_option "ocamlmklib" [ "ocamlmklib" ]
let native_support = BuildValue.new_bool_option "native_support" true
...
let ocaml_config_system = BuildValue.new_strings_option "system" []
let ocaml_config_architecture = BuildValue.new_strings_option "architecture" []
let ocaml_config_ext_obj = BuildValue.new_string_option "ext_obj"  ".o"
let ocaml_config_ext_lib = BuildValue.new_string_option "ext_lib"  ".a"
let ocaml_config_ext_dll = BuildValue.new_string_option "ext_dll"  ".so"
let ocaml_config_os_type = BuildValue.new_strings_option "os_type" [ ]

let ocaml_config_found = BuildValue.new_bool_option "ocaml_config_found" false
