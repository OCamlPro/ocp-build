...
val load : FileGen.t  -> config_input
...
module ProjectOptions : sig
  ...
  val root_files : FileGen.t list SimpleConfig.config_option
...
val load_config : SimpleConfig.config_file -> FileGen.t -> unit
...
val find_project_root : unit -> FileGen.t
